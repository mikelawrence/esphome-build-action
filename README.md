...
| ------------------- | -------- | ------------------------------------------------------------------------------------------------ |
| `substitutions`     | ` `      | Substitution list of key/values in json format. Substitutions are overridden in the `yaml-file`. |
|                     |          | See [ESPHome Substitutions](https://esphome.io/components/substitutions/).                       |
